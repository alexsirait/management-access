...
<header>
    <div class="navbars">
        ...
        <div class="navbars__title" style="margin-top:8px;">
            ...
            <span style="font-size: 12px;"> Aplikasi Management Access </span>
            </div>
        </div>
    </div>
</header>
        ...
        <li class="mt-4">
            <div class="icon-links">
                <div class="d-flex align-items-center">
                    ...
                    <a><span class="link_name ms-1 fs-6 {{ request()->routeIs('index') ? 'text-primary' : '' }}" style="width: 10px; white-space: nowrap; color:#3c59ff">Management Access</span></a>
                </div>
                <a href="javascript:void(0)"><i class="bx bxs-chevron-down arrow"></i></a>
            </div>
            <ul class="sub_menu">
                <li><a class="link_name {{ request()->routeIs('index') ? 'text-primary' : '' }}" href="javascript:void(0)">Management Access</a></li>
                <li><a class="fs-6 {{ request()->routeIs('index') ? 'text-primary' : '' }}" href="/">Management Access</a></li>
            </ul>
        </li>
        <li class="mt-4">
            <div class="icon-links">
